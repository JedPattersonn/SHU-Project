...
interface NetworkEnergyDataProps {
  networkName: string;
  energyData: EnergyData[];
  cities: { id: string; name: string }[];
}

export function NetworkEnergyData({
  networkName,
  energyData,
  cities,
}: NetworkEnergyDataProps) {
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-medium">
            Energy Data for Network Manager: {networkName}
          </h3>
      ...
      <div className="overflow-auto">
        <DataTable
          data={currentData.map((item) => ({
            ...item,
            cityName:
              cities.find((c) => c.id === item.cityId)?.name || item.cityId,
          }))}
          columns={[
            ...
            { header: "Zip Code From", accessorKey: "zipCodeFrom" },
            { header: "Zip Code To", accessorKey: "zipCodeTo" },
